...
If you wish to contribute to soluble-flexstore, please be sure to
...
If you are working on new features or refactoring [create a proposal](https://github.com/belgattitude/soluble-flexstore/issues/new).
...
2. Fork the repository (http://github.com/belgattitude/soluble-flexstore)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/soluble-flexstore.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/soluble-flexstore.git
